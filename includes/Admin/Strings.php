...
return [
	...
	'settings' => [
		...
		'notifications' => [
			'notification'       => __( 'Notification', 'digital-license-manager' ),
			'status'             => __( 'Status', 'digital-license-manager' ),
			'actions'            => __( 'Actions', 'digital-license-manager' ),
			'configure'          => __( 'Configure', 'digital-license-manager' ),
			'enabled'            => __( 'Enabled', 'digital-license-manager' ),
			'disabled'           => __( 'Disabled', 'digital-license-manager' ),
			'done'               => __( 'Done', 'digital-license-manager' ),
			'enable_notification' => __( 'Enable this notification', 'digital-license-manager' ),
			'reminders_explain'  => __( 'Add up to 10 reminder intervals. Each reminder sends a separate email.', 'digital-license-manager' ),
			'days'               => __( 'days', 'digital-license-manager' ),
			'add_reminder'       => __( 'Add Reminder', 'digital-license-manager' ),
			'max_reminders'      => __( 'Maximum of 10 reminders reached.', 'digital-license-manager' ),
		],
		'tabs'  => [
