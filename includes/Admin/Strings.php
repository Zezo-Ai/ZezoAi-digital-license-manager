...
return [
	...
	'licenses' => [
		...
		'hints' => [
			...
			'valid_for'         => __( 'Sets expiration relative to order completion or activation.', 'digital-license-manager' ),
			'activations_limit' => __( 'Maximum number of times this license can be activated. Leave empty for unlimited.', 'digital-license-manager' ),
		],
		'statuses' => [
