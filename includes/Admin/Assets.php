...
class Assets {
	...
	/**
	 * Flatpickr style handle
	 *
	 * @var string
	 */
	const STYLE_HANDLE_FLATPICKR = 'dlm-admin-flatpickr';
	...
	public function register() {
		...
		// Register Flatpickr styles (generated by Vite as separate chunk)
		wp_register_style(
			self::STYLE_HANDLE_FLATPICKR,
			$asset_url . 'styles2.css',
			[],
			$version
		);
	}
	...
	public function enqueue( $hook ) {
		...
		wp_enqueue_style( self::STYLE_HANDLE_FLATPICKR );
